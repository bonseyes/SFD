...
--solver=models/MobileNetV2/SFD-320x320-mod11f-fp16/solver.prototxt \
...
--gpu=0 2>&1 | tee models/MobileNetV2/SFD-320x320-mod11f-fp16/logs/SSD320x320-MobileNetV2-mod11f-NVCaffe-fp16-wider+nir.log
