...
--solver=models/MobileNetV2/SFD-320x320-mod11f-fp16/Person-detection/solver.prototxt \
--weights=/home/ubuntu/caffe-SSD/models/pretrain-MobileNetV2-ImageNet/mod-11/MobileNetV2-320x320-mod11f/snapshots/MobilenetV2-mod11f-ImageNet-caffeSSD_iter_525000.caffemodel \
--gpu=0 2>&1 | tee models/MobileNetV2/SFD-320x320-mod11f-fp16/Person-detection/logs/SSD320x320-MobileNetV2-mod11f-NVCaffe-fp16-person.log
