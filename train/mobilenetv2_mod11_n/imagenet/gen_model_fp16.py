...
"""layer {
    ...
    def generate(self, stage, gen_ssd, size, class_num, nobn, eps, relu6):
      ...
      self.conv_block("conv_1", 48,  t_, 96 , 2, False) #
      self.conv_block("conv_2", 96,  t, 96, 1, True)
      self.conv_block("conv_3", 96,  t, 96, 1, True)  # 
      self.conv_block("conv_4", 96,  t, 96, 1, True)
      self.conv_block("conv_5", 96,  t_, 128, 2, False) #
      ...
      self.conv_block("conv_10", 128,  t_, 160, 2, False) # 
      self.conv_block("conv_11", 160,  t, 160, 1, True)
      self.conv_block("conv_12", 160,  t, 160, 1, True)
      self.conv_block("conv_13", 160,  t, 160, 1, True)
      self.conv_block("conv_14", 160,  t, 160, 1, True)
      self.conv_block("conv_15", 160,  t, 160, 1, True)
      self.conv_block("conv_16", 160,  t, 160, 1, True)
      self.conv_bn_relu_with_factor("Conv_1", 320, 1, 1)
      if gen_ssd is True:
          self.conv_ssd("layer_19", 2, 320, 320)
          self.conv_ssd("layer_19", 3, 320, 320)
          self.conv_ssd("layer_19", 4, 320, 320)
