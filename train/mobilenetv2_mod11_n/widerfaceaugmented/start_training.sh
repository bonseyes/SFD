...
--solver=models/MobileNetV2/SFD-320x320-mod11n-fp16/solver.prototxt \
--gpu=0 2>&1 | tee models/MobileNetV2/SFD-320x320-mod11n-fp16/logs/SSD320x320-MobileNetV2-mod11n-NVCaffe-fp16-wider+gray.log
