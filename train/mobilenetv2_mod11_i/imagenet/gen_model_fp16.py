...
"""layer {
    ...
    def generate(self, stage, gen_ssd, size, class_num, nobn, eps, relu6):
      ...
      self.conv_block("conv_1", 4,  t, 6 , 2, False) #
      self.conv_block("conv_2", 6,  t, 6, 1, True)
      self.conv_block("conv_3", 6,  t, 6, 1, True)  # 
      self.conv_block("conv_4", 6,  t, 6, 1, True)
      self.conv_block("conv_5", 6,  t, 12, 2, False) #
      self.conv_block("conv_6", 12,  t, 12, 1, True)
      self.conv_block("conv_7", 12,  t, 12, 1, True)
      self.conv_block("conv_8", 12,  t, 12, 1, True) #
      self.conv_block("conv_9", 12,  t, 12, 1, True)
      self.conv_block("conv_10", 12,  t, 24, 2, False) # 
      self.conv_block("conv_11", 24,  t, 24, 1, True)
      self.conv_block("conv_12", 24,  t, 24, 1, True)
      self.conv_block("conv_13", 24,  t, 24, 1, True)
      self.conv_block("conv_14", 24,  t, 24, 1, True)
      self.conv_block("conv_15", 24,  t, 24, 1, True)
      self.conv_block("conv_16", 24,  t, 24, 1, True)
      self.conv_bn_relu_with_factor("Conv_1", 48, 1, 1)
      if gen_ssd is True:
          self.conv_ssd("layer_19", 2, 48, 64)
          self.conv_ssd("layer_19", 3, 64, 85)
          self.conv_ssd("layer_19", 4, 85, 106)
