...
--solver=models/MobileNetV2/SFD-320x320-mod11i-fp16/COCO/solver.prototxt \
--weights=/home/ubuntu/caffe-SSD/models/pretrain-MobileNetV2-ImageNet/mod-11/MobileNetV2-320x320-mod11i/snapshots/MobilenetV2-mod11i-ImageNet-caffeSSD_iter_550000.caffemodel \
--gpu=0 2>&1 | tee models/MobileNetV2/SFD-320x320-mod11i-fp16/COCO/logs/SSD320x320-MobileNetV2-mod11i-NVCaffe-fp16-coco.log
