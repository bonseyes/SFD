...
--solver=models/MobileNetV2/SFD-320x320-mod11l-fp16/COCO/solver.prototxt \
...
--gpu=0 2>&1 | tee models/MobileNetV2/SFD-320x320-mod11l-fp16/COCO/logs/SSD320x320-MobileNetV2-mod11l-NVCaffe-fp16-coco.log
