...
--solver=models/MobileNetV2/SFD-320x320-mod11e-fp16/solver.prototxt --weights=/home/ubuntu/caffe-SSD/models/pretrain-MobileNetV2-ImageNet/mod-11/MobileNetV2-320x320-mod11e/snapshots/MobilenetV2-mod11e-ImageNet-caffeSSD_iter_525000.caffemodel --gpu=0 2>&1 | tee models/MobileNetV2/SFD-320x320-mod11e-fp16/logs/SSD320x320-MobileNetV2-mod11e-NVCaffe-fp16-wider+nir.log 
