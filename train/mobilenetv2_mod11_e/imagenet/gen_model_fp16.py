...
"""layer {
    ...
    def generate(self, stage, gen_ssd, size, class_num, nobn, eps, relu6):
      ...
      t = 2
      t_ = 4
      self.conv_bn_relu_with_factor("Conv", 8, 3, 2)
      self.conv_bn_relu_with_factor("Conv_a", 8, 3, 1)
      self.conv_depthwise("conv/depthwise", 8, 1)
      self.conv_project("conv/project", 8, 8)
      self.conv_block("conv_1", 8,  t, 16 , 2, False) #
      self.conv_block("conv_2", 16,  t, 16, 1, True)
      self.conv_block("conv_3", 16,  t, 16, 1, True)  # 
      self.conv_block("conv_4", 16,  t, 16, 1, True)
      self.conv_block("conv_5", 16,  t, 36, 2, False) #
      self.conv_block("conv_6", 36,  t, 36, 1, True)
      self.conv_block("conv_7", 36,  t, 36, 1, True)
      self.conv_block("conv_8", 36,  t, 36, 1, True) #
      self.conv_block("conv_9", 36,  t, 36, 1, True)
      self.conv_block("conv_10", 36,  t, 64, 2, False) # 
      self.conv_block("conv_11", 64,  t, 64, 1, True)
      self.conv_block("conv_12", 64,  t, 64, 1, True)
      self.conv_block("conv_13", 64,  t, 64, 1, True)
      self.conv_block("conv_14", 64,  t, 64, 1, True)
      self.conv_block("conv_15", 64,  t, 64, 1, True)
      self.conv_block("conv_16", 64,  t, 64, 1, True)
      self.conv_bn_relu_with_factor("Conv_1", 96, 1, 1)
      if gen_ssd is True:
          self.conv_ssd("layer_19", 2, 96, 96)
          self.conv_ssd("layer_19", 3, 96, 160)
