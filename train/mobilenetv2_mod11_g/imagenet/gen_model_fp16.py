...
"""layer {
    ...
    def generate(self, stage, gen_ssd, size, class_num, nobn, eps, relu6):
      ...
      t = 2
      t_ = 4
      self.conv_bn_relu_with_factor("Conv", 4, 3, 2)
      self.conv_bn_relu_with_factor("Conv_a", 4, 3, 1)
      self.conv_depthwise("conv/depthwise", 4, 1)
      self.conv_project("conv/project", 4, 4)
      self.conv_block("conv_1", 4,  t, 8 , 2, False) #
      self.conv_block("conv_2", 8,  t, 8, 1, True)
      self.conv_block("conv_3", 8,  t, 8, 1, True)  # 
      self.conv_block("conv_4", 8,  t, 8, 1, True)
      self.conv_block("conv_5", 8,  t, 16, 2, False) #
      self.conv_block("conv_6", 16,  t, 16, 1, True)
      self.conv_block("conv_7", 16,  t, 16, 1, True)
      self.conv_block("conv_8", 16,  t, 16, 1, True) #
      self.conv_block("conv_9", 16,  t, 16, 1, True)
      self.conv_block("conv_10", 16,  t, 32, 2, False) # 
      self.conv_block("conv_11", 32,  t, 32, 1, True)
      self.conv_block("conv_12", 32,  t, 32, 1, True)
      self.conv_block("conv_13", 32,  t, 32, 1, True)
      self.conv_block("conv_14", 32,  t, 32, 1, True)
      self.conv_block("conv_15", 32,  t, 32, 1, True)
      self.conv_block("conv_16", 32,  t, 32, 1, True)
      self.conv_bn_relu_with_factor("Conv_1", 64, 1, 1)
      if gen_ssd is True:
          self.conv_ssd("layer_19", 2, 64, 85)
          self.conv_ssd("layer_19", 3, 85, 113)
          self.conv_ssd("layer_19", 4, 113, 141)
