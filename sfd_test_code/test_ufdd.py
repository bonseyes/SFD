...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description='Test code for a SFD trained model using UFDD dataset.')
    ...
    ufdd_face = sio.loadmat('./output/UFDD/UFDD_val_bbx_gt.mat')
    event_list = ufdd_face['event_list']
    file_list = ufdd_face['file_list']
    del ufdd_face
