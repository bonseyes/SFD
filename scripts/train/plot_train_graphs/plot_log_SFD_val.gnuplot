...
reset
set terminal png
set output "SFD_validation_accuracy.png"
...
#plot "SFD_640x640_WiderFace.log.train" using 1:3 title "SFD training loss"
...
plot "SFD_640x640_WiderFace.log.test" using 1:3 title "SFD validation accuracy"
