...
"""layer {
    ...
    def generate(self, stage, gen_ssd, size, class_num, nobn, eps, relu6):
      ...
      self.conv_block("conv_1", 8,  t, 8 , 2, False) #
      self.conv_block("conv_2", 8,  t, 8, 1, True)
      self.conv_block("conv_3", 8,  t, 12, 1, False)  # 
      self.conv_block("conv_4", 12,  t, 12, 1, True)
      self.conv_block("conv_5", 12,  t, 18, 2, False) #
      self.conv_block("conv_6", 18,  t, 18, 1, True)
      self.conv_block("conv_7", 18,  t, 18, 1, True)
      self.conv_block("conv_8", 18,  t, 24, 1, False) #
      self.conv_block("conv_9", 24,  t, 24, 1, True)
      self.conv_block("conv_10", 24,  t_, 48, 2, False) # 
