...
"""layer {
    ...
    def generate(self, stage, gen_ssd, size, class_num, nobn, eps, relu6):
      ...
      t = 2
      t_ = 4
      self.conv_bn_relu_with_factor("Conv", 12, 3, 2)
      self.conv_bn_relu_with_factor("Conv_a", 12, 3, 1)
      self.conv_depthwise("conv/depthwise", 12, 1)
      self.conv_project("conv/project", 12, 12)
      self.conv_block("conv_1", 12,  t, 24 , 2, False) #
      self.conv_block("conv_2", 24,  t, 24, 1, True)
      self.conv_block("conv_3", 24,  t, 24, 1, True)  # 
      self.conv_block("conv_4", 24,  t, 24, 1, True)
      self.conv_block("conv_5", 24,  t, 48, 2, False) #
      self.conv_block("conv_6", 48,  t, 48, 1, True)
      self.conv_block("conv_7", 48,  t, 48, 1, True)
      self.conv_block("conv_8", 48,  t, 48, 1, True) #
      self.conv_block("conv_9", 48,  t, 48, 1, True)
      self.conv_block("conv_10", 48,  t, 64, 2, False) # 
      ...
      self.conv_bn_relu_with_factor("Conv_1", 128, 1, 1)
      if gen_ssd is True:
          self.conv_ssd("layer_19", 2, 128, 171)
          self.conv_ssd("layer_19", 3, 171, 228)
          self.conv_ssd("layer_19", 4, 228, 285)
