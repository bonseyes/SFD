...
"""layer {
    ...
    def generate(self, stage, gen_ssd, size, class_num, nobn, eps, relu6):
      ...
      self.conv_block("conv_10", 48,  t, 96, 2, False) # 
      self.conv_block("conv_11", 96,  t, 96, 1, True)
      self.conv_block("conv_12", 96,  t, 96, 1, True)
      self.conv_block("conv_13", 96,  t, 96, 1, True)
      self.conv_block("conv_14", 96,  t, 96, 1, True)
      self.conv_block("conv_15", 96,  t, 96, 1, True)
      self.conv_block("conv_16", 96,  t, 96, 1, True)
      self.conv_bn_relu_with_factor("Conv_1", 192, 1, 1)
      if gen_ssd is True:
          self.conv_ssd("layer_19", 2, 192, 192)
          self.conv_ssd("layer_19", 3, 192, 192)
          self.conv_ssd("layer_19", 4, 192, 192)
