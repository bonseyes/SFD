...
"""layer {
    ...
    def generate(self, stage, gen_ssd, size, class_num, nobn, eps, relu6):
      ...
      self.conv_block("conv_5", 6,  t, 8, 2, False) #
      self.conv_block("conv_6", 8,  t, 8, 1, True)
      self.conv_block("conv_7", 8,  t, 8, 1, True)
      self.conv_block("conv_8", 8,  t, 8, 1, True) #
      self.conv_block("conv_9", 8,  t, 8, 1, True)
      self.conv_block("conv_10", 8,  t, 16, 2, False) # 
      self.conv_block("conv_11", 16,  t, 16, 1, True)
      self.conv_block("conv_12", 16,  t, 16, 1, True)
      self.conv_block("conv_13", 16,  t, 16, 1, True)
      self.conv_block("conv_14", 16,  t, 16, 1, True)
      self.conv_block("conv_15", 16,  t, 16, 1, True)
      self.conv_block("conv_16", 16,  t, 16, 1, True)
      self.conv_bn_relu_with_factor("Conv_1", 32, 1, 1)
      if gen_ssd is True:
          self.conv_ssd("layer_19", 2, 32, 43)
          self.conv_ssd("layer_19", 3, 43, 57)
          self.conv_ssd("layer_19", 4, 57, 71)
