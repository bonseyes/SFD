...
"""layer {
    ...
    def generate(self, stage, gen_ssd, size, class_num, nobn, eps, relu6):
      ...
      t = 2
      t_ = 4
      self.conv_bn_relu_with_factor("Conv", 18, 3, 2)
      self.conv_bn_relu_with_factor("Conv_a", 18, 3, 1)
      self.conv_depthwise("conv/depthwise", 18, 1)
      self.conv_project("conv/project", 18, 36)
      self.conv_block("conv_1", 36,  t, 36 , 2, False) #
      self.conv_block("conv_2", 36,  t, 36, 1, True)
      self.conv_block("conv_3", 36,  t, 36, 1, True)  # 
      self.conv_block("conv_4", 36,  t, 36, 1, True)
      self.conv_block("conv_5", 36,  t, 36, 1, True) #
      self.conv_block("conv_6", 36,  t, 36, 1, True)
      self.conv_block("conv_7", 36,  t, 48, 2, False)
      self.conv_block("conv_8", 48,  t, 48, 1, True) #
      self.conv_block("conv_9", 48,  t, 48, 1, True)
      self.conv_block("conv_10", 48,  t, 48, 1, True) # 
      self.conv_block("conv_11", 48,  t, 64, 1, False)
      self.conv_block("conv_12", 64,  t, 64, 1, True)
      self.conv_block("conv_13", 64,  t, 64, 1, True)
      self.conv_block("conv_14", 64,  t, 96, 2, False)
      self.conv_block("conv_15", 96,  t, 96, 1, True)
      self.conv_block("conv_16", 96,  t, 96, 1, True)
      self.conv_block("conv_17", 96,  t, 128, 1, False)
