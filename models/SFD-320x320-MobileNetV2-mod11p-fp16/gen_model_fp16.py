...
"""layer {
    ...
    def generate(self, stage, gen_ssd, size, class_num, nobn, eps, relu6):
      ...
      t = 2
      t_ = 4
      self.conv_bn_relu_with_factor("Conv", 3, 3, 2)
      self.conv_bn_relu_with_factor("Conv_a", 3, 3, 1)
      self.conv_depthwise("conv/depthwise", 3, 1)
      self.conv_project("conv/project", 3, 3)
      self.conv_block("conv_1", 3,  t_, 4 , 2, False) #
      self.conv_block("conv_2", 4,  t, 4, 1, True)
      self.conv_block("conv_3", 4,  t, 4, 1, True)  # 
      self.conv_block("conv_4", 4,  t, 4, 1, True)
      self.conv_block("conv_5", 4,  t, 6, 2, False) #
      self.conv_block("conv_6", 6,  t, 6, 1, True)
      self.conv_block("conv_7", 6,  t, 6, 1, True)
      self.conv_block("conv_8", 6,  t, 6, 1, True) #
      self.conv_block("conv_9", 6,  t, 6, 1, True)
      self.conv_block("conv_10", 6,  t_, 12, 2, False) # 
      self.conv_block("conv_11", 12,  t, 12, 1, True)
      self.conv_block("conv_12", 12,  t, 12, 1, True)
      self.conv_block("conv_13", 12,  t, 12, 1, True)
      self.conv_block("conv_14", 12,  t, 12, 1, True)
      self.conv_block("conv_15", 12,  t, 12, 1, True)
      self.conv_block("conv_16", 12,  t, 12, 1, True)
      self.conv_bn_relu_with_factor("Conv_1", 24, 1, 1)
      if gen_ssd is True:
          self.conv_ssd("layer_19", 2, 24, 24)
          self.conv_ssd("layer_19", 3, 24, 24)
          self.conv_ssd("layer_19", 4, 24, 24)
