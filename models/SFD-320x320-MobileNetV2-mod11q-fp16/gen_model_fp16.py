...
"""layer {
    ...
    def generate(self, stage, gen_ssd, size, class_num, nobn, eps, relu6):
      ...
      self.conv_block("conv_5", 4,  t, 5, 2, False) #
      self.conv_block("conv_6", 5,  t, 5, 1, True)
      self.conv_block("conv_7", 5,  t, 5, 1, True)
      self.conv_block("conv_8", 5,  t, 5, 1, True) #
      self.conv_block("conv_9", 5,  t, 5, 1, True)
      self.conv_block("conv_10", 5,  t_, 6, 2, False) # 
      self.conv_block("conv_11", 6,  t, 6, 1, True)
      self.conv_block("conv_12", 6,  t, 6, 1, True)
      self.conv_block("conv_13", 6,  t, 6, 1, True)
      self.conv_block("conv_14", 6,  t, 6, 1, True)
      self.conv_block("conv_15", 6,  t, 6, 1, True)
      self.conv_block("conv_16", 6,  t, 6, 1, True)
      self.conv_bn_relu_with_factor("Conv_1", 12, 1, 1)
      if gen_ssd is True:
          self.conv_ssd("layer_19", 2, 12, 12)
          self.conv_ssd("layer_19", 3, 12, 12)
          self.conv_ssd("layer_19", 4, 12, 12)
