...
"""layer {
    ...
    def generate(self, stage, gen_ssd, size, class_num, nobn, eps, relu6):
      ...
      self.conv_project("conv/project", 24, 16)
      self.conv_block("conv_1", 16,  t, 24, 2, False)
      ...
      self.conv_block("conv_6", 32,  t, 64, 2, False)
      ...
      self.conv_block("conv_13", 96,  t, 160, 2, False)
