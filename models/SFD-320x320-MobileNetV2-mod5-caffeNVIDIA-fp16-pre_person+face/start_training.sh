...
--solver=models/MobileNetV2/SFD-320x320-mod-5-fp16-pre_person+face/solver.prototxt \
...
--gpu=0 2>&1 | tee models/MobileNetV2/SFD-320x320-mod-5-fp16-pre_person+face/logs/SSD320x320-MobileNetV2-mod5-NVCaffe-fp16-wider-pre_person+face.log
