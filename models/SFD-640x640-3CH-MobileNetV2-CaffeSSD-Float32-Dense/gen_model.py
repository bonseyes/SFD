...
"""layer {
    ...
    def generate(self, stage, gen_ssd, size, class_num, nobn, eps, relu6):
      ...
      self.conv_block("conv_1", 16,  6, 24, 1, False)
      self.conv_block("conv_2", 24,  6, 24, 1, True)
      self.conv_block("conv_3", 24,  6, 32, 2, False) # out 24!
      ...
      self.conv_block("conv_10", 64,  6, 96, 1, False)  # change is size should happen here!
