...
"""layer {
    ...
    def generate(self, stage, gen_ssd, size, class_num, nobn, eps, relu6):
      ...
      if stage == "train":
          ...
          self.data_deploy()
      t = 3
      self.conv_bn_relu_with_factor("Conv", 32, 3, 1)  #2
      self.max_pool_k3_st2("Conv_pool")
      self.conv_depthwise("conv/depthwise", 32, 1)
      self.conv_project("conv/project", 32, 16)
      self.conv_block("conv_1", 16,  t, 24, 1, False)
      self.max_pool_k3_st2("conv1_pool")
      self.conv_block("conv_2", 24,  t, 24, 1, True)
      self.conv_block("conv_3", 24,  t, 32, 1, False)
      self.conv_block("conv_4", 32,  t, 32, 1, True)
      self.conv_block("conv_5", 32,  t, 32, 1, True)
      self.conv_block("conv_6", 32,  t, 64, 1, False)
      self.max_pool_k3_st2("conv6_pool")
      self.conv_block("conv_7", 64,  t, 64, 1, True)
      self.conv_block("conv_8", 64,  t, 64, 1, True)
      self.conv_block("conv_9", 64,  t, 64, 1, True)
      self.conv_block("conv_10", 64,  t, 96, 1, False) 
      self.conv_block("conv_11", 96,  t, 96, 1, True)
      self.conv_block("conv_12", 96,  t, 96, 1, True)
      self.conv_block("conv_13", 96,  t, 160, 1, False)
      self.max_pool_k3_st2("conv13_pool")
      self.conv_block("conv_14", 160,  t, 160, 1, True)
      self.conv_block("conv_15", 160,  t, 160, 1, True)
      self.conv_block("conv_16", 160,  t, 320, 1, False)
      ...
      if gen_ssd is True:
          ...
          self.mbox("conv_13/expand_", 2)
          self.mbox("Conv_1", 1)
          self.mbox("layer_19_2_2", 1)
          self.mbox("layer_19_2_3", 1)
          self.mbox("layer_19_2_4", 1)
          #self.mbox("layer_19_2_5", 6)
          self.concat_boxes(['conv_13/expand_', 'Conv_1', 'layer_19_2_2', 'layer_19_2_3', 'layer_19_2_4']) #, 'layer_19_2_5'])
          if stage == "train":
             self.ssd_loss()
          elif stage == "deploy":
             self.ssd_predict()
